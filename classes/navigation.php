...
namespace qbank_generatequestion;
...
class navigation extends \core_question\local\bank\navigation_node_base {
    ...
    public function get_navigation_title(): string {
        return get_string('nav_title_generatequestion', 'qbank_generatequestion');
    }
    ...
    public function get_navigation_url(): \moodle_url {
        return new \moodle_url('/question/bank/generatequestion/generatequestion.php');
    }
